...
# Load .mat files
fault1_mat = loadmat("fault1.mat")
fault2_mat = loadmat("fault2.mat")
fault3_mat = loadmat("fault3.mat")
healthy_mat = loadmat("data_healthy.mat")
...
# Read to csv files
#fault1.to_csv(r"fault1.csv", index=False)
#fault2.to_csv(r"fault2.csv", index=False)
#fault3.to_csv(r"fault3.csv", index=False)
#healthy.to_csv(r"healthy.csv", index=False)
